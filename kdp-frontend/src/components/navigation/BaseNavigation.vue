<template>
  <div class="container">
    <div class="logo">
      <router-link to="/">
        <svg
          class="shadow logo-style"
          version="1.1"
          id="rs-logo"
          xmlns="http://www.w3.org/2000/svg"
          x="0"
          y="0"
          viewBox="0 0 595.3 504.9"
          xml:space="preserve"
        >
          <path
            class="st0"
            d="M547.4 198.1s-7.6-10.4-123.1-30l-8.9 66.4s51.6.8 107.7 22.5c0 0-13.2-18.8-26.7-43.4 0 0 17.8-5.6 51-15.5zM42 196.9s7.6-10.4 123.1-30l8.9 66.4s-51.6.8-107.7 22.5c0 0 13.2-18.8 26.7-43.4 0 0-17.7-5.5-51-15.5z"
          ></path>
          <path
            class="st1"
            d="M471.7 227.4l-56.2 7-2.5-19.7c-.1.1 4.1-4.1 58.7 12.7zM117.2 226.9l57.6 7.3 1.5-16.4s-4.6-7.7-59.1 9.1z"
          ></path>
          <path
            id="path3741_18_"
            d="M138.9 120.3c87.1-30.3 230-26.5 311.6 0 0 0 24.2 192.6-27.7 244.5C395.5 392.1 293.7 470 293.7 470s-101.8-77.8-129.2-105.3c-51.8-51.8-25.6-244.4-25.6-244.4z"
            fill="#ffe000"
          ></path>
          <radialGradient
            id="path3374_1_"
          ...
          <path
            id="path3374_12_"
            d="M296.9 113.9c-47.1-.5-95.2 2.5-143.7 18.4-1 7.9-5.5 42.6-5.6 90.8 0 26.7 1.4 54.8 5.9 78.7 4.6 23.9 12.7 43 21.9 52.2 12.1 12.1 44.7 38.8 73.4 61.6 23.9 19 38.4 30.1 44.9 35.1 6.5-5 21-16.2 44.9-35.1 28.7-22.8 61.3-49.5 73.4-61.6 9.2-9.2 17.5-28.3 22.3-52.2 4.8-23.9 6.4-52 6.6-78.7.4-48.1-3.9-82.7-4.9-90.8-46-14.1-92.3-17.9-139.1-18.4z"
            fill="url(#path3374_1_)"
          ></path>
          <path
            d="M287.4 304.2a36.33 36.33 0 010-51.4 36.33 36.33 0 0151.4 0l34.3-34.3a84.8 84.8 0 00-119.9 0 84.8 84.8 0 000 119.9l34.2-34.2zm-34.2 34.2a36.33 36.33 0 0051.4 0 36.33 36.33 0 000-51.4l34.3-34.2a84.8 84.8 0 010 119.9 84.8 84.8 0 01-119.9 0l34.2-34.3z"
          ></path>
          <path
            d="M117.6 226.4s186.3-31.9 354.1 1l-13.3-53.2-331 20-9.8 32.2z"
            opacity=".3"
            fill-rule="evenodd"
            clip-rule="evenodd"
          ></path>
